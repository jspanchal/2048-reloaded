    ...
    public static class TextBoxExtensions
    {
        ...
        public static void SetScrollTo(this Control control, ScrollViewer scrollViewer)
        {
            ...
            control.GotFocus +=
                (sender, args) =>
                {
                    GeneralTransform transform = control.TransformToVisual(scrollViewer);
                    ...
                    {
                        scrollViewer.ScrollToVerticalOffset(scrollViewer.VerticalOffset + positionInScrollViewer.Y -
                                                            SCROLL_PADDING);
                    }
                    ...
                    {
                        scrollViewer.ScrollToHorizontalOffset(scrollViewer.HorizontalOffset + positionInScrollViewer.X -
                                                              SCROLL_PADDING);
                    }
                };
        }
